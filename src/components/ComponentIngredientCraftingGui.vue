        ...
        <div class="w-full bg-[#c6c6c6]">
            ...
            <div class="p-2">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <div class="flex">
                            <ComponentIngredientSlot :item="slot_1" />
                            <ComponentIngredientSlot :item="slot_2" />
                            <ComponentIngredientSlot :item="slot_3" />
                        </div>
                        <div class="flex">
                            <ComponentIngredientSlot :item="slot_4" />
                            <ComponentIngredientSlot :item="slot_5" />
                            <ComponentIngredientSlot :item="slot_6" />
                        </div>
                        <div class="flex">
                            <ComponentIngredientSlot :item="slot_7" />
                            <ComponentIngredientSlot :item="slot_8" />
                            <ComponentIngredientSlot :item="slot_9" />
                        </div>
                    </div>
...
import ComponentIngredientSlot from "@/components/ComponentIngredientSlot.vue";

export default {
    components: {ComponentIngredientSlot, TreeSimulatorInputSlot, ItemSlot: ItemSlot},
    props: ['slot_1', 'slot_2', 'slot_3', 'slot_4', 'slot_5', 'slot_6', 'slot_7', 'slot_8','slot_9', 'output', 'output_count', 'component'],
}
</script>
