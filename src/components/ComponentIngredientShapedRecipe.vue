<script setup>
import ComponentCraftingGui from "@/components/ComponentCraftingGui.vue";
import ComponentIngredientCraftingGui from "@/components/ComponentIngredientCraftingGui.vue";
...
<template>
    <ComponentIngredientCraftingGui
